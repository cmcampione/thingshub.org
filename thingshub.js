...
/* harmony export */ });
/* harmony import */ var _accountManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accountManager */ "./src/accountManager.ts");
/* harmony import */ var _thingsDataContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./thingsDataContext */ "./src/thingsDataContext.ts");
/* harmony import */ var _realtimeConnectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./realtimeConnectors */ "./src/realtimeConnectors.ts");
/* harmony import */ var _thing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./thing */ "./src/thing.ts");
/* harmony import */ var _thingsManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./thingsManager */ "./src/thingsManager.ts");
...
class thingsHub {
    constructor(address, apiKey, thingsKind) {
        ...
        this.thingsManagerClaims = {
            publicReadClaims: 0 /* NoClaims */,
            publicChangeClaims: 0 /* NoClaims */,
            everyoneReadClaims: 0 /* NoClaims */,
            everyoneChangeClaims: 0 /* NoClaims */,
            creatorUserReadClaims: 65535 /* AllClaims */,
            creatorUserChangeClaims: 1048575 /* AllClaims */
        };
        this.onError = (error) => console.log(error);
        this.onConnectError = (error) => console.log(error);
        this.onStateChanged = (change) => console.log(change);
        this.endPointAddress.server = address + ":3000";
        this.endPointAddress.api = address + ":3000/api";
        this.accountManager = new _accountManager__WEBPACK_IMPORTED_MODULE_0__.AccountManager("thingshub", this.endPointAddress, apiKey);
...
ThingUserChangeClaims.CanOtherUsersChangeMyThingPos;
...
/* harmony export */   "th": () => (/* reexport safe */ _th__WEBPACK_IMPORTED_MODULE_11__.th)
/* harmony export */ });
...
/* harmony import */ var _th__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./th */ "./src/th.ts");
